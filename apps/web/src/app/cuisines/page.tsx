...
export const metadata: Metadata = {
  title: 'Cuisines',
  description: 'Browse Emrooz recipes by cuisine.',
};
...
export default async function CuisineIndex() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 pt-10 pb-16">
      <div className="text-xs uppercase tracking-widest text-ink-400">Explore</div>
      <h1 className="font-display text-4xl md:text-5xl text-ink-900 mt-1">Cuisines</h1>
      <p className="text-ink-500 mt-2 max-w-xl">
        A global menu. Every cuisine is a first-class citizen — from familiar staples to under-served
        traditions.
      </p>
          ...
          <li key={c.id}>
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 text-white">
                <div className="text-xs uppercase tracking-widest opacity-70">Cuisine</div>
