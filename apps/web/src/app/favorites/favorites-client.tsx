...
export default function FavoritesClient() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 pt-10 pb-16">
      <div className="text-xs uppercase tracking-widest text-ink-400">Saved</div>
      <h1 className="font-display text-4xl md:text-5xl text-ink-900 mt-1">Favorites</h1>
      ...
      {q.data?.recipes.length === 0 && (
        <div className="mt-10 card p-8 text-center">
          ...
          <h2 className="mt-4 font-display text-2xl text-ink-900">No favorites yet</h2>
          <p className="text-ink-500 mt-2">Tap the heart on any recipe you love, and it will land here.</p>
